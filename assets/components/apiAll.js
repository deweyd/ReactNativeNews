...
const useApiAll = (category) => {
    ...
    useEffect(() => {
        ...
        const url = `https://newsapi.org/v2/top-headlines?country=us&category=${category}&page=1&pageSize=50&apiKey=${apiKey}`;
